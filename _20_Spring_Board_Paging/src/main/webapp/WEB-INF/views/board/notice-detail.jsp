    ...
    <div>
        ...
        <main>
            ...
            <div class="container mt-3 w-50">
                <form id="updateForm" action="/board/modify.do" method="post">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="text" class="form-control" id="nickname" name="nickname" value="${notice.nickname}" readonly>
                    </div>
                    <div class="form-group mt-3">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="text" class="form-control" id="regdate" value="<javatime:format value="${notice.regdate}" pattern="yyyy-MM-dd"/>" readonly required>
                    </div>
                    <div class="form-group mt-3">
                        <label for="moddate">수정일</label>
                        <input type="text" class="form-control" id="moddate" value="<javatime:format value="${notice.moddate}" pattern="yyyy-MM-dd"/>" readonly required>
                    </div>
                    <div class="form-group mt-3">
                        <label for="cnt">조회수</label>
                        <input type="text" class="form-control" id="cnt" name="cnt" value="${notice.cnt}" readonly required>
                    </div>
                    <div class="form-group mt-3">
