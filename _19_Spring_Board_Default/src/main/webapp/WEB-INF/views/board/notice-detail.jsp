        ...
        <main>
            ...
            <div class="container mt-3 w-50">
                <form id="updateForm" action="/board/modify.do" method="post">
                    ...
                    <c:if test="${loginMember ne null and loginMember.id eq notice.WRITER_ID}">
                        <button type="submit" id="btn-update" class="btn btn-outline-secondary">수정</button>
                    </c:if>
                    <c:if test="${loginMember ne null and (loginMember.id eq notice.WRITER_ID or loginMember.role eq 'ADMIN')}">
