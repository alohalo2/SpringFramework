                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">작성일:
                                <!--fmt:parseDate: LocalDateTime 타입을 Data 타입으로 변환
                                <fmt:parseDate value="${notice.regdate}" pattern="yyyy-MM-dd'T'HH:mm:SS" var="parseRegdate"  type="both"/>
                                <!--fmt:formatDate: Date 타입의 날짜를 형식 지정에 맞게 표출-->
